...
//we also want to take bookings to our eurowings flight. Taking the same method above (book) and simply
// copying and pasting is bad practice. So we store this method in a variable so we can reuse it for all our different airlines.

const book = lufthansa.book;
//we can do this because js has first class functions . Functions are simply values.
book(23, 'Sarah Hart');
// book function is just a regular function call. It's no longer the method.
// As we learned before a regular function call the this keyword points to window.
...
//now this function only needs the name because I preset flight number as a parameter
bookEW23('Pini');
console.log(euroWings);
